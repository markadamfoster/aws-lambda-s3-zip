...
exports.handler = function(event, _context, callback) {
  ...
  const zipFolder = event.zipFolder; // 'zip/5e7b4c8e04a53ce79486f04e/xrd7YoMh2WaXlk81U/'
  const zipFileName = event.zipFileName; // 'Photos.zip'
        ...
        if (r) {
          ...
          axios
            .post(responseAPIUrl, {
              status: "success",
              downloadClientId,
              zipFolderAndFile: `${zipFolder}${zipFileName}`
            })
